...
class VM {
	...
	private void productList() {
		...
		case 0:										break;
		default : System.out.println("### 메뉴 입력 에러 ###"); System.out.println();
		}
	}
		...
		do {
			...
			case 0:
				...
				if(id.equals(admin.getId()) && pw.equals(admin.getPw())) {
					...
					admin.setMoney(vmMoney);
					System.out.printf("자판기 수금액 : %d원\n", vmMoney);					
					break;
				}else {
					System.out.println("관리자만이 자판기를 완전 종료시킬 수 있습니다.");
					System.out.println();
					menu = 1;
					break;
				}
